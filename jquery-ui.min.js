...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, draggable.js, resizable.js, button.js, dialog.js, menu.js, selectmenu.js, slider.js, spinner.js, tooltip.js
...
(function(e) {
    ...
    e.widget("ui.button", {
        ...
        _create: function() {
            ...
            this.buttonElement.addClass(h).attr("role", "button").bind("mouseenter" + this.eventNamespace, function() {
        ...
        _destroy: function() {
            ...
            this.buttonElement.removeClass(h + " ui-state-active " + l).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()),
